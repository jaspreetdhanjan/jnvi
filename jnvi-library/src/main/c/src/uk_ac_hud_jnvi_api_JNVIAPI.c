...
Java_uk_ac_hud_jnvi_api_JNVIAPI_add(JNIEnv *env, jclass clazz, jbyte type, jlong srcA, jlong srcB, jlong dest) {
...
JNIEXPORT void JNICALL
JavaCritical_uk_ac_hud_jnvi_api_JNVIAPI_add(jbyte type, jlong srcA, jlong srcB, jlong dest) {
    if(type == JNVI_TYPE_DOUBLE) {
        double *av = (void*) srcA;
        double *bv = (void*) srcB;
        double *cv = (void*) dest;
...
JNIEXPORT void JNICALL
Java_uk_ac_hud_jnvi_api_JNVIAPI_sub(JNIEnv *env, jclass clazz, jbyte type, jlong srcA, jlong srcB, jlong dest) {
    if(type == JNVI_TYPE_DOUBLE) {
        double *av = (void*) srcA;
        double *bv = (void*) srcB;
        double *cv = (void*) dest;
...
JNIEXPORT void JNICALL
JavaCritical_uk_ac_hud_jnvi_api_JNVIAPI_sub(jbyte type, jlong srcA, jlong srcB, jlong dest) {
    if(type == JNVI_TYPE_DOUBLE) {
        double *av = (void*) srcA;
        double *bv = (void*) srcB;
        double *cv = (void*) dest;
...
JNIEXPORT void JNICALL
Java_uk_ac_hud_jnvi_api_JNVIAPI_mul(JNIEnv *env, jclass clazz, jbyte type, jlong srcA, jlong srcB, jlong dest) {
    if(type == JNVI_TYPE_DOUBLE) {
        double *av = (void*) srcA;
        double *bv = (void*) srcB;
        double *cv = (void*) dest;
...
JNIEXPORT void JNICALL
JavaCritical_uk_ac_hud_jnvi_api_JNVIAPI_mul(jbyte type, jlong srcA, jlong srcB, jlong dest) {
    if(type == JNVI_TYPE_DOUBLE) {
        double *av = (void*) srcA;
        double *bv = (void*) srcB;
        double *cv = (void*) dest;
...
JNIEXPORT void JNICALL
Java_uk_ac_hud_jnvi_api_JNVIAPI_div(JNIEnv *env, jclass clazz, jbyte type, jlong srcA, jlong srcB, jlong dest) {
    if(type == JNVI_TYPE_DOUBLE) {
        double *av = (void*) srcA;
        double *bv = (void*) srcB;
        double *cv = (void*) dest;
...
JNIEXPORT void JNICALL
JavaCritical_uk_ac_hud_jnvi_api_JNVIAPI_div(jbyte type, jlong srcA, jlong srcB, jlong dest) {
    if(type == JNVI_TYPE_DOUBLE) {
        double *av = (void*) srcA;
        double *bv = (void*) srcB;
        double *cv = (void*) dest;
